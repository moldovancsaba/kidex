...
const TEMPLATES = {
  en: {
    ...
    body: (link: string) => `
      ...
      <a href="${link}" style="padding: 12px 24px; background: #008080; color: white; text-decoration: none; border-radius: 6px; display: inline-block;">Login to Dashboard</a>
  ...
  hu: {
    ...
    body: (link: string) => `
      ...
      <a href="${link}" style="padding: 12px 24px; background: #008080; color: white; text-decoration: none; border-radius: 6px; display: inline-block;">Belépés a Vezérlőpultra</a>
  ...
  ar: {
    ...
    body: (link: string) => `
      <div dir="rtl">
        ...
        <a href="${link}" style="padding: 12px 24px; background: #008080; color: white; text-decoration: none; border-radius: 6px; display: inline-block;">تسجيل الدخول إلى لوحة التحكم</a>
